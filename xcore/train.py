...
def train(conf: omegaconf.DictConfig) -> None:
    ...
    pl_module: CrossPLModule = hydra.utils.instantiate(conf.model.module, _recursive_=False)

    # pl_module = tempPLModule.load_from_checkpoint(conf.evaluation.checkpoint, _recursive_=False, map_location="cuda:0")
